...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			...
			'subnavigation_text_hover_color' => '#fe422e',
			...
			'fixed_side_content_link_color' => '#fe422e',
			...
			'content_title_color' => '',
			'blog_header_bg_color' => '#111111',
			'blog_header_bg_s_color' => 'rgba(255,255,255,0)',
			'blog_header_title_color' => 'rgba(254,66,46,0.8)',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#ffffff',
			'blog_header_button_bg' => '#fe422e',
			'blog_header_button_hover' => '#ffffff',
			'blog_header_button_hover_bg' => '#fe422e',
			...
			'form_button_background_color' => '#fe422e',
			'form_button_background_color_hover' => '#fe422e',
			'form_button_text_color' => '#ffffff',
			'form_button_text_color_hover' => '#ffffff',
			'back_to_top_background_color' => 'rgba(254,66,46,0.7)',
			'back_to_top_background_color_hover' => '#fe422e',
			'back_to_top_text_color' => '#333333',
			'back_to_top_text_color_hover' => '#fbb533',
		);
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			'font_body' => 'Lato',
			'font_body_category' => '',
			'font_body_variants' => '100,300,regular,700,900',
			...
			'font_top_bar_variants' => '100,300,regular,700,900',
			...
			'font_buttons' => 'Roboto Mono',
			'font_buttons_category' => '',
			'font_buttons_variants' => '100,300,regular,500,700',
			...
			'font_footer_variants' => '100,300,regular,700,900',
			'footer_weight' => '700',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Roboto+Mono:100,300,regular,500,700|Montserrat:100,200,300,regular,500,600,700,800,900|Lato:100,300,regular,700,900' );
